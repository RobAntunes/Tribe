...
export const AgentCard: React.FC<AgentCardProps> = ({
    ...
    useEffect(() => {
        ...
        // Second priority: use the backstory from the agent spec
        else if (safeAgent.backstory) {
            setAgentDescription(safeAgent.backstory);
        } 
        // Third priority: try to extract from agent messages
    ...
    }, [messages, safeAgent.id, safeAgent.backstory, safeAgent.short_description]);
            ...
            <div className="agent-card-content" onClick={() => onSelect(agent)}>
                ...
                <div className="agent-settings">
                    <div className="setting-group">
                        <label htmlFor={`autonomy-${safeAgent.id}`}>Autonomy:</label>
                        <select 
                            id={`autonomy-${safeAgent.id}`}
                    ...
                    <div className="setting-group">
                        ...
                        <div 
                            className={`toggle-switch ${safeAgent.learningEnabled ? 'active' : ''}`}
                            onClick={(e) => { e.stopPropagation(); handleToggleLearning(); }}
                        >
