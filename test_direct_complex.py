...
def test_direct_complex():
    """Test if the Lambda API responds for a complex agent request when sent directly."""
    ...
    logger.info("Sending complex agent request directly to Lambda API...")
    ...
    try:
        response = requests.post(
            ...
            timeout=60  # 60 second timeout for complex request
        )
...
if __name__ == "__main__":
    logger.info("Starting direct complex agent test")
    result = test_direct_complex()
